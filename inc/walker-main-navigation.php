<?php
if ( ! class_exists( 'Walker_main_navigation' ) ) {
	/**
	...
	class Walker_main_navigation extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if (in_array('menu-item-has-children', $item->classes)) {
				$arrow = '<button class="btn-menu-plus" role="button" aria-label="Toggle child menu">+</button>'; // Change the class to your font icon
